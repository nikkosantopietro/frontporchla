  ...
  <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#ffffff;">
   ...
   <!-- ZONE MAP -->
    <tr><td style="padding:28px 40px;border-bottom:1px solid #d4e8c8;">
      <p style="margin:0 0 10px;font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#4a6741;font-family:Arial,sans-serif;">Your Zone &nbsp;·&nbsp; ${zoneName}</p>
    ...
    <tr><td style="padding:28px 40px;border-bottom:1px solid #d4e8c8;background:#fafcf8;">
      <p style="margin:0;font-size:15px;line-height:1.8;color:#2c2c2a;font-family:Georgia,serif;">${intro}</p>
    </td></tr>
          ...
          <td width="49%" style="padding-right:5px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr><td style="background:#f2f7ee;border:1px solid #d4e8c8;border-radius:7px;padding:13px 8px;text-align:center;">
                ...
                <p style="margin:0;font-size:10px;color:#6a8f5e;font-family:Arial,sans-serif;">Past 12 months</p>
              </td></tr>
            </table>
          </td>
          ...
          <td width="49%" style="padding-right:5px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr><td style="background:#f2f7ee;border:1px solid #d4e8c8;border-radius:7px;padding:13px 8px;text-align:center;">
                ...
                <p style="margin:0;font-size:10px;color:#2d7a4f;font-family:Arial,sans-serif;">Past 12 months</p>
                <a href="https://frontporchla.com/api/track?sid=${subscriberId}&lid=sold&dest=${encodeURIComponent(listingsUrl)}" style="font-size:10px;color:#4a6741;font-family:Arial,sans-serif;display:block;margin-top:3px;">View listings →</a>
              </td></tr>
            </table>
          </td>
          <td width="49%" style="padding-left:5px;">
    ...
    <!-- ALL LISTINGS LINK -->
    <tr><td style="padding:4px 40px 24px;text-align:center;border-bottom:1px solid #d4e8c8;">
      <a href="https://frontporchla.com/api/track?sid=${subscriberId}&lid=listings-all&dest=${encodeURIComponent(listingsUrl)}" style="display:inline-block;background:#3d5a47;color:#f5f9f2;padding:12px 24px;border-radius:6px;font-size:13px;letter-spacing:.5px;font-family:Arial,sans-serif;text-decoration:none;">See every sale &amp; active listing &#8594;</a>
      <p style="margin:8px 0 0;font-size:11px;color:#9b9088;font-family:Arial,sans-serif;">Full data — prices, sq ft, year built, and more</p>
    </td></tr>

    <!-- ATTOM HOME VALUE -->
    <tr><td style="padding:28px 40px;border-bottom:1px solid #d4e8c8;">
      <a href="https://frontporchla.com/api/track?sid=${subscriberId}&lid=home-value&dest=${encodeURIComponent('https://frontporchla.com/api/how-value')}" style="text-decoration:none;display:block;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr><td style="background:#1e3318;border-radius:8px;padding:20px 22px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="vertical-align:middle;">
                  <p style="margin:0 0 5px;font-size:9px;letter-spacing:2px;text-transform:uppercase;color:#b8d4a8;font-family:Arial,sans-serif;">Your Property's Estimated Value &nbsp;·&nbsp; ${address}</p>
                  ...
                  <p style="margin:6px 0 0;font-size:10px;color:#8ab87a;font-family:Arial,sans-serif;font-style:italic;">Learn how the value was estimated →</p>
                  ` : `
                  <p style="margin:0;font-size:16px;color:#f5f9f2;font-family:Georgia,serif;font-style:italic;line-height:1.5;">Curious what your property is worth?</p>
