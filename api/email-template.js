  ...
  <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#ffffff;">
   ...
   <!-- ZONE MAP -->
    ...
    <tr><td style="padding:4px 40px 24px;text-align:center;border-bottom:1px solid #d4e8c8;">
      <a href="https://frontporchla.com/api/listings" style="display:inline-block;background:#3d5a47;color:#f5f9f2;padding:12px 24px;border-radius:6px;font-size:13px;letter-spacing:.5px;font-family:Arial,sans-serif;text-decoration:none;">See every sale &amp; active listing &#8594;</a>
